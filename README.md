...
<details>
  <summary><b>Export to BVH for VRM</b></summary>

To convert generated motion data to BVH format for VRM avatar compatibility:

```
python -m closd.diffusion_planner.utils.npy2bvh\
 --input_path results.npy\
 --output_dir ./bvh_output\
 --fps 20
```

- The `results.npy` file is generated by the text-to-motion generation script
- BVH files can be used with VRM avatars via [UniVRM](https://github.com/vrm-c/UniVRM) or [three-vrm](https://github.com/pixiv/three-vrm)
- The script handles the full HumanML3D skeleton (22 joints) with proper hierarchy
- Coordinate system is Y-up, Z-forward (compatible with VRM)
</details>
